...
export const KINTONE_PLUGINS: KintonePlugin[] = [
  ...
  },
  {
    ...
    price: 36000,
    trialVersion: true,
    memo: '98,000円で買い切りも可能。警告メッセージが出ますが、無期限でトライアル可能。',
  },
  {
    author: 'かりんこラボ',
    name: '年度記録プラグイン',
  ...
  },
  {
    ...
    price: 0,
    priceType: '無料',
    memo: '無料の場合、1日1回、月額サポートの紹介メッセージ有り',
  },
  {
    author: 'TiS',
    name: '添付ファイル一括ダウンロードプラグイン',
  ...
  },
  {
    ...
    price: 3000,
    trialVersion: true,
    memo: '同社が提供するプラグイン3つで6,000円/月、プラグイン使い放題で14,000円/月プランあり。',
  },
  {
    author: '株式会社ジョイゾー',
    name: 'カードビュープラグイン',
  ...
  },
  {
    ...
    priceType: '買い切り',
    price: 98000,
    memo: 'ご購入後１年間のみ、３回のメールお問い合わせサポートが可能',
  },
  {
    author: 'アールスリーインスティテュート',
    name: '承認ステップ図示プラグイン',
