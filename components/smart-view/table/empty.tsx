  ...
  <div {...{ className }}>
    <svg height="200" viewBox="0 0 512 512" width="200">
      <g>
        ...
        <path
          d="m198.791 372.217 57.209-90.872-198.791-65.895-57.209 90.872z"
          fill="#ddd"
        />
        <path
          d="m313.209 372.217-57.209-90.872 198.791-65.895 57.209 90.872z"
          fill="#ccc"
        />
      </g>
    </svg>
    <h2>条件に一致するプラグインが見つかりませんでした。</h2>
    <div></div>
  </div>
);
